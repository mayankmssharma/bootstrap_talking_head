...
train = load_clean_sentences('model_data/train.pkl')
test = load_clean_sentences('model_data/test.pkl')
...
model.fit(trainX, trainY, epochs=80, batch_size=64, validation_data=(testX, testY), verbose=1)
#plot_model(model, to_file='model_data/model.png')
filename = 'model_uno.h5'

os.chdir(os.curdir + '/model_data')
model.save(filename)